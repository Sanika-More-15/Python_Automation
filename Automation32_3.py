# Design automation script which accept directory name and write names of duplicate files from that directory 
...
# Usage : DirectoryDuplicate.py "Demo" ( Demo is the name of directory)
