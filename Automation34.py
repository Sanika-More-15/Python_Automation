# python Automation34.py "Demo"
# python Automation34.py --history
# python Automation34.py --restore "Backup_2026-02-15_12-23-33.zip" "Restored"
...
SENDER_PASSWARD="lxlfbshvlghpkowz"
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage :")
        print("Backup : python script.py source source_folder")
